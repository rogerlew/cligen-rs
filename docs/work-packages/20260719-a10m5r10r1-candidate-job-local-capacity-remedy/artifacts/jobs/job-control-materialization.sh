...
target=${TMPDIR:-/tmp}/a10m5r10r1-$role-$SLURM_JOB_ID
...
if not os.path.exists(setup_path):
    value = {
        ...
        'containment': {},
        'execution_identity': {},
        'exit_codes': {'pip_check': 125, 'pip_install': 125, 'runtime_version': 125},
        'identities': {},
        'job_local_storage': {},
...
admission_ok = (
    ...
    and admission.get('record_type') == 'a10m5r10r1-submission-admission'
