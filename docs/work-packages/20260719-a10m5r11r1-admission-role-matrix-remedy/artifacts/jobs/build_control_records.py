#!/usr/bin/env python3
"""Build private A10M5R11R1 authority and plan records."""
...
PACKAGE_ID = "20260719-a10m5r11r1-admission-role-matrix-remedy"
RUN_ID = "a10m5r11r1-admission-role-matrix-remedy-r0"
AUTHORITY_ID = "a10m5r11r1-admission-role-matrix-remedy-authority"
BUDGET_ID = "a10m5r11r1-admission-role-matrix-remedy-budget"
AUTHORITY_TOKEN = "a10m5r11r1-admission-role-matrix-remedy-authority-token"
TOOLKIT_HARDENING_COMMIT = "0ddffd9ac5db2440f74f54285e0df1c2ac856c98"
PREDECESSOR_COMMIT = "3b1e42ffc548c94cc5cae2e231d67d89942bd745"
ROLES = (
...
PREDECESSOR_FILES = (
    "docs/work-packages/20260719-a10m5r11-retained-adapter-temporal-generalization/artifacts/operational-summary.json",
    "docs/work-packages/20260719-a10m5r11-retained-adapter-temporal-generalization/artifacts/execution-disposition.md",
    "docs/work-packages/20260719-a10m5r11-retained-adapter-temporal-generalization/artifacts/toolkit-abort.json",
    "docs/work-packages/20260719-a10m5r11-retained-adapter-temporal-generalization/artifacts/gate-results.md",
    "docs/work-packages/20260719-a10m5r11-retained-adapter-temporal-generalization/package.md",
)
...
def predecessor_bundle() -> dict[str, object]:
    ...
    if (
        summary.get("terminal") != "HOLD-A10M5R11-ADMISSION-ROLE-MATRIX"
        or execution.get("jobs_submitted") != 0
        or execution.get("gpu_minutes_consumed") != 0
        or cleanup.get("remote_absent") is not True
    ):
        raise RuntimeError("predecessor admission hold semantics drift")
    return {"package_id": "20260719-a10m5r11-retained-adapter-temporal-generalization", "record_commit": PREDECESSOR_COMMIT, "files": files}
