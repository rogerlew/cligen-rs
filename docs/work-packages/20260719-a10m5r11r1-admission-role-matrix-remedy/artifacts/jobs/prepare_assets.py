#!/usr/bin/env python3
"""Prepare immutable A10M5R11 execution assets."""
...
SCIENCE = {
    ...
    "portfolio-contract.json": "docs/work-packages/20260719-a10m5r10-parallel-architecture-portfolio/artifacts/portfolio-contract.json",
...
PACKAGE_ASSETS = (
    ...
    "temporal_candidate_experiment.py", "temporal_metrics.py",
