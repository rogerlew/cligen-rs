...
Production usage:
  run-wepp-matrix-v6.py CANDIDATE_MANIFEST CANDIDATE_CLI_DIR \
      CLIGEN_BINARY OUTPUT_DIR [--wepp-repo PATH] [--workers 1..4]

Self-test usage:
  run-wepp-matrix-v6.py --self-test [--wepp-repo PATH]
...
CAMPAIGN = RUNNER.with_name("wepp-campaign-v3.md")
ANALYZER = RUNNER.with_name("analyze-wepp-v6.py")
...
def verify_normative_hashes() -> None:
    ...
    if (
        freeze.get("post_climate_wepp_freeze_version") != 2
    ...
    diagnostics = require_dict(
        freeze.get("diagnostic_identities"), "post-climate diagnostics"
    )
    if diagnostics != {
        "v5_zero_record": {
            "coordinate": {
                "station_id": "ca042319", "profile_id": "faithful_off",
                "horizon_years": 30, "replicate": 3, "legacy_burn": 503,
            },
            "cli": {
                "sha256": "e1b0a25f7c09125ca2ac295b5ceb9e6d0b0a34e06598370d200036cfa641c416",
                "bytes": 779_050,
            },
            "element": {
                "sha256": "2480929b4bdb86ceebde23f4084ab955a82afd35868fe6146d51f15c87791fda",
                "bytes": 138_613,
            },
            "event_hydrology": {
                "sha256": "5819b40d07863382b22a07f254f806d8327ddadb5f25bae8157670cd01fedd39",
                "bytes": 4_050,
            },
            "stdout": {
                "sha256": "3426f6f9ac0b0f0b1d781cae488197a7612c0a1253447347337929200623fe41",
                "bytes": 6_261,
            },
            "stderr": {
        ...
        "v6_effint_overflow": {
            "coordinate": {
                "station_id": "az022664",
                "profile_id": "full_monthly_covariance",
                "horizon_years": 30,
                "replicate": 1,
                "legacy_burn": 17,
            },
            "cli": {
                "sha256": "5cac86f2708a830863294f76b6321b1cd67e67eaa1190d1c969c7b64b82fecf9",
                "bytes": 778_946,
            },
            "element": {
                "sha256": "27d4c58fbee84ed343939e1f25846e89f6f15cef3e2ecc0cd037e4da756e360d",
                "bytes": 149_749,
            },
            "event_hydrology": {
                "sha256": "ea9c1671350aa23699a0921bf3010dacb01f629c28226f24bf82cb943179e6fe",
                "bytes": 139_966,
            },
            "stdout": {
                "sha256": "8f75554b4ebe3354b214869cc8c55b82f13792d87673775f49c92667486a9494",
                "bytes": 11_019,
            },
            "stderr": {
                "sha256": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",
        ...
        raise CampaignError("post-climate diagnostic identities differ")
...
def self_test(wepp_repo: Path) -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="a5b-wepp-self-test-", dir=target_root) as temporary:
        ...
        zero_record_event = parse_event_hydrology(
            write_event_mutation("zero-record", zero_record_event_lines), 30
        )
        if (
        ...
        parse_element(zero_element_path, 30, zero_record_event)
