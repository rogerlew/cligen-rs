...
Adapter ID: `a5b_wepp_p326_response_extractor_v5`.
...
only to this v5 contract and runner.
...
must name `a5b_wepp_p326_response_extractor_v5` and bind the frozen runner's
