...
Adapter ID: `a5b_wepp_p326_response_extractor_v6`.
...
WEPP evidence is generated only by this v6 runner and contract.
...
must name `a5b_wepp_p326_response_extractor_v6` and bind the frozen runner's
