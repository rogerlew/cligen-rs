...
Production usage:
  run-wepp-matrix-v5.py CANDIDATE_MANIFEST CANDIDATE_CLI_DIR \
      CLIGEN_BINARY OUTPUT_DIR [--wepp-repo PATH] [--workers 1..4]

Self-test usage:
  run-wepp-matrix-v5.py --self-test [--wepp-repo PATH]
...
CAMPAIGN = RUNNER.with_name("wepp-campaign-v2.md")
ANALYZER = RUNNER.with_name("analyze-wepp-v5.py")
...
POST_CLIMATE_AMENDMENT = (
    PACKAGE / "artifacts/freeze/post-climate-wepp-amendment-v1.md"
)
POST_CLIMATE_FREEZE = (
    PACKAGE / "artifacts/freeze/post-climate-wepp-freeze-v1.json"
)
...
EXTRACTION_ADAPTER_ID = "a5b_wepp_p326_response_extractor_v5"
...
def verify_normative_hashes() -> None:
    ...
    if (
        freeze.get("post_climate_wepp_freeze_version") != 1
        or freeze.get("status") != "passed"
        or freeze.get("boundary")
        != {
            "candidate_climate_output_present": True,
            "candidate_response_values_inspected": False,
