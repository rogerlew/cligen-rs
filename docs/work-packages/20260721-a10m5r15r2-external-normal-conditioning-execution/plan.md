...
2. Using the pinned R14R2R2 r3 assets and accepted E0 evidence, run
   `artifacts/calibrate_attribution.py` with bootstrap seeds 410542 and 410543.
   Commit the candidate-blind receipt and bind its exact hash into the execution
   contract.
