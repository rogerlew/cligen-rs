...
def main() -> None:
    ...
    require(freeze["parent_freeze_sha256"] == freeze_v3_claimed, "freeze v4 parent mismatch")
    require(amendment_003["parent_freeze_sha256"] == freeze_v3_claimed, "amendment 003 parent mismatch")
    require(freeze["amendment_sha256"] == sha256(AMENDMENT_003), "amendment 003 hash mismatch")
