...
def main() -> None:
    ...
    require(freeze["parent_freeze_sha256"] == freeze_v2_claimed, "freeze v3 parent mismatch")
    require(amendment_002["parent_freeze_sha256"] == freeze_v2_claimed, "amendment 002 parent mismatch")
    require(freeze["amendment_sha256"] == sha256(AMENDMENT_002), "amendment 002 hash mismatch")
