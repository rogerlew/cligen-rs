#!/usr/bin/env python3
"""Materialize R14 admissions through the authenticated hardened controller."""
...
def verify_published_source(source_commit: str) -> None:
    ...
    if not (
        ...
        raise RuntimeError("R14 admission wrapper is not exact published main")
...
def fetch_and_verify(
    ...
    if not (
        ...
        raise RuntimeError("materialized R14 admission receipt failed authentication")
    return receipt
