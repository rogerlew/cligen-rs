#!/usr/bin/env python3
"""Prepare immutable A10M5R8 Lemhi assets."""
...
def main() -> None:
    ...
    copy(PACKAGE / "artifacts/climate-objective-contract.json", root / "climate-objective-contract.json")
    ...
    generated.extend(
        [
            ...
            "train.py",
            "legacy_core.py",
            "climate-objective-contract.json",
