...
claim=a10-canonical-v2-env-$SLURM_JOB_ID
...
printf '{"authority_id":"a10-canonical-v2-env-smoke-authority","attempt":0,"base":"%s","job_id":"%s","node":"%s","package_id":"a10-lemhi-canonical-v2-environment-closure-smoke","run_id":"a10-canonical-v2-env-smoke-r1","target":"%s","uid":%s}\n' \
...
printf '{"attempt":"signal","job_id":"%s","run_id":"a10-canonical-v2-env-smoke-r1","target":"%s","uid":%s}\n' \
...
value["gates"].update({
    ...
    "environment_closure": True,
    "environment_entry_recorded": True,
...
rmdir -- "$base"
trap - EXIT
printf '%s\n' A10-LEMHI-CANONICAL-V2-ENV-SMOKE-PASS
