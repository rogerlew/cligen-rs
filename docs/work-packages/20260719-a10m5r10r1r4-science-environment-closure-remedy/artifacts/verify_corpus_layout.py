#!/usr/bin/env python3
"""Verify the exact staged corpus archive identity and extraction layout."""
...
PIN_BYTES = 864
PIN_SHA256 = "ea17be0acecc8afc99714c1c9df42511440382c2b8fb6d0511b0aad3414069d3"
...
def main() -> None:
    ...
    staged_identity = manifest.get("assets", {}).get("corpus.tar")
    layout = inspect_layout(options.archive)
    gates = {
        "archive_identity": archive_identity == pin["archive"],
        "asset_manifest_identity": staged_identity == pin["archive"],
