#!/usr/bin/env python3
"""Build private A10M5R9 authority input and plan records."""
...
PACKAGE_ID = "20260719-a10m5r9-climate-normal-residual-architecture"
RUN_ID = "a10m5r9-climate-normal-residual-r0"
AUTHORITY_ID = "a10m5r9-climate-normal-residual-authority"
BUDGET_ID = "a10m5r9-climate-normal-residual-budget"
AUTHORITY_TOKEN = "a10m5r9-climate-normal-residual-authority-token"
...
def authority(options: argparse.Namespace) -> None:
    value = {
        ...
        "resource_class": "one-l40-climate-normal-residual-architecture",
...
def plan(options: argparse.Namespace) -> None:
    ...
    evidence = [
        "recovery.json",
        "results/climate-normal-residual/baseline-training.json",
        "results/climate-normal-residual/calendar-preflight.json",
        "results/climate-normal-residual/comparison.json",
        "results/climate-normal-residual/control-identity.json",
        "results/climate-normal-residual/decision.json",
        "results/climate-normal-residual/evidence.json",
        "results/climate-normal-residual/residual-training.json",
        "results/climate-normal-residual/supervisor.json",
        "slurm/climate-normal-residual.0.out",
        "slurm/climate-normal-residual.0.err",
        ...
        "jobs": [
            {
                ...
                "gate_receipt": "results/climate-normal-residual/evidence.json",
                "gpus": 1,
                "gres": "gpu:l40:1",
                "max_attempts": 1,
                "memory_mb": 98304,
                ...
                "script": "job-climate-normal-residual.sh",
