...
SCIENCE = {
    ...
    "portfolio-contract.json": "docs/work-packages/20260719-a10m5r12r1-admission-materialization-remedy/artifacts/portfolio-contract.json",
...
def main() -> None:
    ...
    admission_root = root / "controller-admissions"
    admission_root.mkdir(mode=0o700, exist_ok=True)
    if admission_root.is_symlink() or any(admission_root.iterdir()):
        raise RuntimeError("controller admission directory is not fresh")
    generated: list[str] = []
