...
| [SPEC-A10-CLIMATE-STATISTICS-TRAINING](SPEC-A10-CLIMATE-STATISTICS-TRAINING.md) | Research-only same-P1 control/treatment objective using realized monthly and annual precipitation/Tmax/Tmin statistics and dispersions | research-only (rev 1; A10M5R8; no public runtime identifier) |
