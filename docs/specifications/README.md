...
| [SPEC-A11-MULTI-MEMBER-FORCING-STABILITY](SPEC-A11-MULTI-MEMBER-FORCING-STABILITY.md) | Eight-member common-RNG stability screen for the frozen regional-median and nearest-candidate forcing adapters | research-only rev 1; A11E3 scaffolded; no confirmation or promotion authority |
