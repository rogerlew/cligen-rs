...
| [SPEC-A10-STOCHASTIC-PRISM-COMPARATOR](SPEC-A10-STOCHASTIC-PRISM-COMPARATOR.md) | Longitude/latitude/years mode that selects a station, localizes six `.par` rows to hash-pinned Norm91m monthly ppt/Tmax/Tmin, and runs unchanged faithful CLIGEN with complete provenance | research-only (rev 1 scaffold; A10M5R4R1; no public generation profile) |
