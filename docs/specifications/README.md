...
| [SPEC-A10-EXTERNAL-NORMAL-CONDITIONING](SPEC-A10-EXTERNAL-NORMAL-CONDITIONING.md) | Research-only normals-conditioned candidate contract: matched P2 adapter and backbone-free replacement pairs under the unchanged temporal protocol | research-only **RATIFIED** (rev 1; A10M5R15; ADR-0006/0007) |
