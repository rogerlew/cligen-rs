...
| [SPEC-A10-EXTERNAL-NORMAL-CONDITIONING](SPEC-A10-EXTERNAL-NORMAL-CONDITIONING.md) | Research-only normals-conditioned candidate contract: no-normals control, normals-augmented climatology, and normal-anchored residual under the unchanged temporal protocol | research-only **DRAFT** (rev 0; proposed A10M5R15; ADR-0006/0007; not ratified) |
...
| [SPEC-LEMHI-MULTI-GPU-CAPABILITY](SPEC-LEMHI-MULTI-GPU-CAPABILITY.md) | Optional single-node two/four-L40 toolkit, correctness, accounting, admission, and attestation contract | authoritative (rev 1; A10M5O1/A10M5O2) |
