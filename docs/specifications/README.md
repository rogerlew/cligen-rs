...
| [SPEC-A11-EXPLORATORY-STRATEGY-LAB](SPEC-A11-EXPLORATORY-STRATEGY-LAB.md) | Versioned exploratory laboratory for multiple non-neural annual/monthly strategies and shared conditional daily primitives | research-only active rev 1; no confirmation or promotion authority |
