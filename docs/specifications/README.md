...
| [SPEC-A11-NEAREST-CANDIDATE-FORCING](SPEC-A11-NEAREST-CANDIDATE-FORCING.md) | Single-factor nearest-candidate-fit forcing-location test for the retained exploratory circular-block arm | research-only rev 1; A11E2 active; no confirmation or promotion authority |
