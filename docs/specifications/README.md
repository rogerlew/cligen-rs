...
| [SPEC-QUALITY-REPORT](SPEC-QUALITY-REPORT.md) | Machine-readable per-run climate quality report (the ADR-0002 instrument; [v2 schema](quality-report-v2.schema.json), [preserved v1 schema](quality-report-v1.schema.json), [latest alias](quality-report.schema.json)) | active (rev 7, envelope 2 / metrics 2 — A1) |
