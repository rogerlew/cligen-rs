...
| [SPEC-LEMHI-AGENT-TOOLKIT](SPEC-LEMHI-AGENT-TOOLKIT.md) | Agent workflow lifecycle, provider contracts, receipts, safety boundaries, and cleanup for Lemhi | authoritative (rev 2; operational hardening implemented) |
