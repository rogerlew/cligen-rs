...
| [SPEC-LEMHI-MULTI-GPU-CAPABILITY](SPEC-LEMHI-MULTI-GPU-CAPABILITY.md) | Optional single-node two/four-L40 toolkit, correctness, accounting, admission, and attestation contract | proposed (rev 1; A10M5O1/A10M5O2) |
