...
| [SPEC-A11-OBSERVED-EXPLORATORY-EXECUTION](SPEC-A11-OBSERVED-EXPLORATORY-EXECUTION.md) | Role-correct observed-development comparison of integrated annual strategies, two-part physical daily adapter, and mask-normalized Daymet estimands | research-only rev 1; A11E1 active; no confirmation or promotion authority |
