...
| [SPEC-LEMHI-MULTI-GPU-CAPABILITY](SPEC-LEMHI-MULTI-GPU-CAPABILITY.md) | Single-node one/two-L40 canonical capacity plus exceptional three/four-L40 validation, accounting, admission, and attestation contract | authoritative (rev 3; A10M5O1/A10M5O2/A10M5O2D1; ADR-0008) |
