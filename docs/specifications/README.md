...
| [SPEC-LEMHI-AGENT-TOOLKIT](SPEC-LEMHI-AGENT-TOOLKIT.md) | Agent workflow lifecycle, provider contracts, receipts, safety boundaries, and cleanup for Lemhi | authoritative design (rev 1; implementation pending) |
