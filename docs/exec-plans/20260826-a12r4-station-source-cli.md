...
- [x] Record operator decision and scaffold contract/package.
...
All end-to-end runs use new output directories. Failed runs must leave no final
directory. Existing v1 artifacts and A12 evidence remain immutable historical
records; this package advances new runtime artifacts rather than rewriting them.
