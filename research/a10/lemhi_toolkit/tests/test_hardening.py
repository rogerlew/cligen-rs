...
class V2IntegrationTests(HardeningFixture):
    ...
    def test_v2_external_cleanup_revalidates_hashes_and_releases_reserve(self) -> None:
        ...
        evidence = {
            ...
            "remote_command": "/ceph/home/rogerlew.ui/.cligen-rs-a10/runs/v2-run/cleanup-cancelled-1000.sh",
            "remote_stderr": "/ceph/home/rogerlew.ui/.cligen-rs-a10/runs/v2-run/slurm/cancelled-cleanup.0.err",
            "remote_stdout": "/ceph/home/rogerlew.ui/.cligen-rs-a10/runs/v2-run/slurm/cancelled-cleanup.0.out",
            "result": "validated-delete",
